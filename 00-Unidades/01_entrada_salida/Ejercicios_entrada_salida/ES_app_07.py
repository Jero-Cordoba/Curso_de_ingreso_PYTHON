...
class App(customtkinter.CTk):
    ...
    def btn_sumar_on_click(self):
        ...
        alert("Ejercicio 7", f"El resultado de la suma es: {suma}")
    ...
    def btn_restar_on_click(self):
        ...
        alert("Ejercicio 7", f"El resultado de la resta es: {resta}")
    ...
    def btn_multiplicar_on_click(self):
        ...
        alert("Ejercicio 7", f"El resultado de la multiplicación es: {multiplicacion}")
    ...
    def btn_dividir_on_click(self):
        ...
        alert("Ejercicio 7", f"El resultado de la división es: {división}")
